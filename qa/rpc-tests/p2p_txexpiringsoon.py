...
class TxExpiringSoonTest(BitcoinTestFramework):
    ...
    def verify_inv(self, testnode, tx):
        ...
        # Send p2p message "mempool" to receive contents from ziced node in "inv" message
        with mininode_lock:
    ...
    def run_test(self):
        ...
        # Mininodes send expiring soon transaction in "tx" message to ziced node
        ...
        # Mininodes send transaction in "tx" message to ziced node
