...
Jack Grigg (21):
      ...
      Add ZiCE revision to version strings
      Bitcoin -> ZiCE in version and help text
      Add ZiCE Developers to CLI copyright notice
...
Nathan Wilcox (1):
      Fix a test name bug so that ``make cov-zice`` correctly runs the ``zice-gtest`` binary. Fixes #946.
...
Taylor Hornby (16):
      ...
      Turn on -Werror for the ZiCE build.
