...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total ZiCE balance of the wallet\n"
...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"ziceaddress\"\n"
            "\nReturn information about the given ZiCE address.\n"
            "\nArguments:\n"
            "1. \"ziceaddress\"     (string, required) The ZiCE address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"ziceaddress\",   (string) The ZiCE address validated\n"
...
UniValue createmultisig(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2)
    {
        string msg = "createmultisig nrequired [\"key\",...]\n"
            ...
            "2. \"keys\"       (string, required) A json array of keys which are ZiCE addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"key\"    (string) ZiCE address or hex-encoded public key\n"
            "       ,...\n"
            "     ]\n"
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"ziceaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"
            "\nArguments:\n"
            "1. \"ziceaddress\"    (string, required) The ZiCE address to use for the signature.\n"
...
UniValue getaddressmempool(const UniValue& params, bool fHelp)
{
    ...
    if (!fExperimentalInsightExplorer) {
        throw JSONRPCError(RPC_MISC_ERROR, "Error: getaddressmempool is disabled. "
            "Run './zice-cli help getaddressmempool' for instructions on how to enable this feature.");
    }
...
UniValue getaddressutxos(const UniValue& params, bool fHelp)
{
    ...
    if (!fExperimentalInsightExplorer) {
        throw JSONRPCError(RPC_MISC_ERROR, "Error: getaddressutxos is disabled. "
            "Run './zice-cli help getaddressutxos' for instructions on how to enable this feature.");
    }
...
UniValue getaddressdeltas(const UniValue& params, bool fHelp)
{
    ...
    if (!fExperimentalInsightExplorer) {
        throw JSONRPCError(RPC_MISC_ERROR, "Error: getaddressdeltas is disabled. "
            "Run './zice-cli help getaddressdeltas' for instructions on how to enable this feature.");
    }
...
UniValue getaddressbalance(const UniValue& params, bool fHelp)
{
    ...
    if (!fExperimentalInsightExplorer) {
        throw JSONRPCError(RPC_MISC_ERROR, "Error: getaddressbalance is disabled. "
            "Run './zice-cli help getaddressbalance' for instructions on how to enable this feature.");
    }
...
UniValue getaddresstxids(const UniValue& params, bool fHelp)
{
    ...
    if (!fExperimentalInsightExplorer) {
        throw JSONRPCError(RPC_MISC_ERROR, "Error: getaddresstxids is disabled. "
            "Run './zice-cli help getaddresstxids' for instructions on how to enable this feature.");
    }
...
UniValue getspentinfo(const UniValue& params, bool fHelp)
{
    ...
    if (!fExperimentalInsightExplorer) {
        throw JSONRPCError(RPC_MISC_ERROR, "Error: getspentinfo is disabled. "
            "Run './zice-cli help getspentinfo' for instructions on how to enable this feature.");
    }
