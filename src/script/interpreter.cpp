...
const unsigned char ZICE_PREVOUTS_HASH_PERSONALIZATION[crypto_generichash_blake2b_PERSONALBYTES] =
    {'Z','c','a','s','h','P','r','e','v','o','u','t','H','a','s','h'};
const unsigned char ZICE_SEQUENCE_HASH_PERSONALIZATION[crypto_generichash_blake2b_PERSONALBYTES] =
    {'Z','c','a','s','h','S','e','q','u','e','n','c','H','a','s','h'};
const unsigned char ZICE_OUTPUTS_HASH_PERSONALIZATION[crypto_generichash_blake2b_PERSONALBYTES] =
    {'Z','c','a','s','h','O','u','t','p','u','t','s','H','a','s','h'};
const unsigned char ZICE_JOINSPLITS_HASH_PERSONALIZATION[crypto_generichash_blake2b_PERSONALBYTES] =
    {'Z','c','a','s','h','J','S','p','l','i','t','s','H','a','s','h'};
const unsigned char ZICE_SHIELDED_SPENDS_HASH_PERSONALIZATION[crypto_generichash_blake2b_PERSONALBYTES] =
    {'Z','c','a','s','h','S','S','p','e','n','d','s','H','a','s','h'};
const unsigned char ZICE_SHIELDED_OUTPUTS_HASH_PERSONALIZATION[crypto_generichash_blake2b_PERSONALBYTES] =
    {'Z','c','a','s','h','S','O','u','t','p','u','t','H','a','s','h'};

uint256 GetPrevoutHash(const CTransaction& txTo) {
    CBLAKE2bWriter ss(SER_GETHASH, 0, ZICE_PREVOUTS_HASH_PERSONALIZATION);
...
uint256 GetSequenceHash(const CTransaction& txTo) {
    CBLAKE2bWriter ss(SER_GETHASH, 0, ZICE_SEQUENCE_HASH_PERSONALIZATION);
    for (unsigned int n = 0; n < txTo.vin.size(); n++) {
...
uint256 GetOutputsHash(const CTransaction& txTo) {
    CBLAKE2bWriter ss(SER_GETHASH, 0, ZICE_OUTPUTS_HASH_PERSONALIZATION);
...
uint256 GetJoinSplitsHash(const CTransaction& txTo) {
    CBLAKE2bWriter ss(SER_GETHASH, static_cast<int>(txTo.GetHeader()), ZICE_JOINSPLITS_HASH_PERSONALIZATION);
...
uint256 GetShieldedSpendsHash(const CTransaction& txTo) {
    CBLAKE2bWriter ss(SER_GETHASH, 0, ZICE_SHIELDED_SPENDS_HASH_PERSONALIZATION);
...
uint256 GetShieldedOutputsHash(const CTransaction& txTo) {
    CBLAKE2bWriter ss(SER_GETHASH, 0, ZICE_SHIELDED_OUTPUTS_HASH_PERSONALIZATION);
    ...
    const PrecomputedTransactionData* cache)
{
    ...
    if (sigversion == SIGVERSION_OVERWINTER || sigversion == SIGVERSION_SAPLING) {
        ...
        memcpy(personalization, "ZiCESigHash", 12);
