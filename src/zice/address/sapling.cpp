// Copyright (c) 2016-2020 The ZiCE developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or https://www.opensource.org/licenses/mit-license.php .

#include "zice/address/sapling.hpp"
...
const unsigned char ZICE_SAPLING_FVFP_PERSONALIZATION[crypto_generichash_blake2b_PERSONALBYTES] =
...
uint256 SaplingFullViewingKey::GetFingerprint() const {
    CBLAKE2bWriter ss(SER_GETHASH, 0, ZICE_SAPLING_FVFP_PERSONALIZATION);
    ss << *this;
    return ss.GetHash();
}
