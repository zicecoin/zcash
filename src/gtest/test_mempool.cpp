...
TEST(Mempool, SproutNegativeVersionTxWhenOverwinterActive) {
    ...
    // A Sprout transaction with version -3 is created using Sprout code (as found in ziced <= 1.0.14).
    ...
    // A Sprout transaction with version -3 created using Overwinter code (as found in ziced >= 1.0.15).
