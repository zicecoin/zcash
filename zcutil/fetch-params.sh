...
Failed to fetch the ZiCE zkSNARK parameters!
...
function main() {
    ...
    cat <<EOF
ZiCE - fetch-params.sh

This script will fetch the ZiCE zkSNARK parameters and verify their
...
EOF
    ...
    then
        ...
        cat >> "$README_PATH" <<EOF
This directory stores common ZiCE zkSNARK parameters. Note that it is
